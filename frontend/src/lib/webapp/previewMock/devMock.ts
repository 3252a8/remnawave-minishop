...
export const DEV_MOCK: PreviewMock = {
  config: {
    ...
    referralWebappLinkEnabled: true,
    referralTelegramLinkEnabled: true,
    legacyRefs: true,
      ...
      bonus_details: [
        {
          ...
          friend_max_days: 14,
          details: [
            { id: "standard:1", months: 1, title: "1 месяц", inviter_days: 14, friend_days: 7 },
            { id: "standard:3", months: 3, title: "3 месяца", inviter_days: 21, friend_days: 14 },
          ],
        },
        {
          id: "tariff:premium",
          ...
          friend_max_days: 31,
          details: [
            { id: "premium:6", months: 6, title: "6 месяцев", inviter_days: 31, friend_days: 21 },
            {
              id: "premium:12",
              months: 12,
              title: "12 месяцев",
