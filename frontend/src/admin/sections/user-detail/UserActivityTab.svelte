  ...
  {#if (openedUserDetail.recent_payments || []).length}
    <div class="admin-user-payments-table">
      <AdminTable class="admin-table-compact admin-user-payments-table-grid">
        <colgroup>
          <col class="admin-user-payment-col-id" />
          <col class="admin-user-payment-col-amount" />
          <col class="admin-user-payment-col-status" />
          <col class="admin-user-payment-col-date" />
          <col class="admin-user-payment-col-provider" />
          <col class="admin-user-payment-col-description" />
          <col class="admin-user-payment-col-discount" />
          <col class="admin-user-payment-col-traffic" />
          <col class="admin-user-payment-col-traffic" />
        </colgroup>
        <thead>
          <tr>
...
<style>
  ...
  .admin-user-payments-table :global(.admin-user-payment-col-id) {
    width: 108px;
  }

  .admin-user-payments-table :global(.admin-user-payment-col-amount) {
    width: 92px;
  }

  .admin-user-payments-table :global(.admin-user-payment-col-status) {
    width: 104px;
  }

  .admin-user-payments-table :global(.admin-user-payment-col-date) {
    width: 132px;
  }

  .admin-user-payments-table :global(.admin-user-payment-col-provider) {
    width: 132px;
  }

  .admin-user-payments-table :global(.admin-user-payment-col-description) {
    width: 190px;
  }

  .admin-user-payments-table :global(.admin-user-payment-col-discount) {
    width: 100px;
  }

  .admin-user-payments-table :global(.admin-user-payment-col-traffic) {
    width: 116px;
  }
