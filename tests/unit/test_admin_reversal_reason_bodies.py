...
def test_reversal_reason_is_required_without_explicit_flag(
    body_type: type[AdminPaymentReverseBody] | type[AdminGiftRevokeBody],
) -> None:
...
@pytest.mark.parametrize("body_type", [AdminPaymentReverseBody, AdminGiftRevokeBody])
def test_reversal_reason_can_be_empty_with_explicit_flag(
    body_type: type[AdminPaymentReverseBody] | type[AdminGiftRevokeBody],
) -> None:
