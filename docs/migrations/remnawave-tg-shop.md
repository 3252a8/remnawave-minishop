...
| `remnawave-minishop-angie-acme` | создается Angie-профилем; хранит ACME-аккаунт и сертификаты Let's Encrypt |
...
Готовые Caddy, Angie, Nginx, Pangolin/Newt и no-proxy профили уже содержат нужную
маршрутизацию.
