...
| --- | --- | --- | --- | --- | --- | --- |
| current | rw3-numeric-user-id | 3.3.2, 3.3.0, 3.2.3, 3.2.1, 3.2.0, 3.1.0, 3.0.0 | 3.3.2 | numeric-user-ids, user-stream, user-stream-filters, targeted-squad-bulk, connections-drop, hwid-user-id-selector, empty-success-body, multi-node-usage, multi-node-top-users, bulk-squad-update | fixture, live-read, live-write, upgrade | [release notes](https://github.com/remnawave/backend/releases/tag/3.3.2) |
...
| `users.lookup.username` | GET | `/users/by-username/{username}` | rw2-uuid-user-id, rw3-numeric-user-id | 200 | JSON envelope with response | The username lookup route remains stable through 3.3.2; 3.1+ reports an absent user as 404/A063. | unit, live-read |
...
| --- | --- | --- | --- |
| 2.8.1 | 3.3.2 | same-panel-database | `tests/qa/test_remnawave_upgrade.py` |
...
Manifest review date: `2026-08-20`.
