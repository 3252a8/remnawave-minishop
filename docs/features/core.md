...
- Регистрация и вход через [email-код, email/пароль, Telegram, Google, Яндекс или passkey](login-methods.md).
- Просмотр подписки, срока действия, трафика и ссылки подключения.
- Покупка подписки, пакетов трафика и дополнительных устройств.
- Пробный период, [промокоды](promocodes.md) и реферальные сценарии.
...
- Рассылки, [промокоды](promocodes.md) и логи действий.
