...
Интеграция читает публичные внутренние endpoints страницы статуса Uptime Kuma. Upstream не
гарантирует стабильность их формата между версиями, поэтому после обновления Uptime Kuma проверьте
встроенный экран статуса в Minishop.
