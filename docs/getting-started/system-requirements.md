...
- Для автономного режима — SMTP, публичный URL кабинета и постоянные ключи почтового входа. Токен бота нужен только при включённом Telegram; права администратора выдаются роли аккаунта.
