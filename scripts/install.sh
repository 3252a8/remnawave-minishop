...
DEFAULT_IMAGE_REPOSITORY_PREFIX="${MINISHOP_IMAGE_REPOSITORY_PREFIX:-3252a8/remnawave-minishop}"
...
Переменные окружения для значений по умолчанию:
  ...
  MINISHOP_IMAGE_REPOSITORY_PREFIX
                            префикс app-образов ($DEFAULT_IMAGE_REPOSITORY_PREFIX)
...
prompt_common_env() {
    ...
    prompt_value "Префикс Docker-образов приложения" "$(env_get IMAGE_REPOSITORY_PREFIX "$DEFAULT_IMAGE_REPOSITORY_PREFIX")" 0 0 ""
    IMAGE_REPOSITORY_PREFIX_VALUE="$PROMPT_VALUE"
...
display_env_summary() {
    ...
    show_env_value IMAGE_REPOSITORY_PREFIX "$IMAGE_REPOSITORY_PREFIX_VALUE"
...
render_env_file() {
    ...
    env_line IMAGE_REPOSITORY_PREFIX "$IMAGE_REPOSITORY_PREFIX_VALUE" "$output"
