...
def _migration_0091_user_id_sequence(connection: Connection) -> None:
...
CHAIN_0091_USER_ID_SEQUENCE: list[Migration] = [
    Migration(
        id="0091_user_id_sequence",
        description="Assign internal user IDs from a database sequence, independent of Telegram",
        upgrade=_migration_0091_user_id_sequence,
    )
]
