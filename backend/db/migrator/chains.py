...
from .chain_0090_account_identity import CHAIN_0090_ACCOUNT_IDENTITY
from .chain_0091_user_id_sequence import CHAIN_0091_USER_ID_SEQUENCE
from .chain_0092_panel_origin import CHAIN_0092_PANEL_ORIGIN
...
MIGRATIONS: list[Migration] = [
    ...
    *CHAIN_0090_ACCOUNT_IDENTITY,
    *CHAIN_0091_USER_ID_SEQUENCE,
    *CHAIN_0092_PANEL_ORIGIN,
]
